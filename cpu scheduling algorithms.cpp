...
char line1[] = { "Bapuji Institute of Engineering and Technology" };
char line2[] = { "Computer Science Department" };
char line3[] = { "Computer Graphics project" };
char line4[] = { "Topic: Process Scheduling Algorithm" };
char line5[] = { "Sheetal P	 : 4BD17CS100" };
char line6[] = { "Sonika Prakash : 4BD17CS104" };
...
void displayName(const char* lines)
{
    displayText(500, 450, 1, 1, 1, lines);
}

void displayfirst(void) {
    displayText(392, 450, 0, 0, 1, line1);
    displayText(470, 400, 0, 0, 1, line2);
    displayText(470, 350, 0, 0, 0, line3);
    displayText(80, 150, 0, 0, 1, line4);
...
void strin(const char* p, int n, GLint x, GLint y)
{
    glRasterPos2f(x, y);
    for (int i = 0; i < n; i++)
...
void stri(const char* p, int n, GLint x, GLint y)
{
    glColor3f(1, 0.9, 0);
    glRasterPos2f(x, y);
    for (int i = 0; i < n; i++)
...
void constr() // To show the constraints
{
    ...
    strin("Made by Sheetal and Sonika", 26, 5, 20);
    glColor3f(0, 0, 0);
}
...
void displayOptions()
{
    ...
    table();
    //char s = tq + '0';
    std::string str = std::to_string(tq);
    const char *s = str.c_str();
    //tring str = string(s);
    displayText(50, 400, 1, 1, 1, "set of processes");
    displayText(50, 401, 1, 1, 1, "____________");
    //displayText(310 + 60, 290, 1, 1, 0, "Time Quantum = ");
    //displayText(490 + 60, 290, 1, 1, 0, &s);
    //displayText(491 + 60, 290, 1, 1, 0, "ms");
    displayText(50, 100, 1, 1, 0, "Time Quantum = ");
    displayText(225 ,100, 1, 1, 0, &*s);
}
